...
| P5b-03 | Transport remote: play, pause, style, colour mode, with the Digital Crown scrubbing the timeline | P5b-02 | done in code; paired devices needed to confirm |
